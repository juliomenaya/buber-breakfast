...
- [Buber Breakfast API](#buber-breakfast-api)
  ...
  - [List Breakfasts](#list-breakfasts)
    - [List Breakfast Request](#list-breakfasts-request)
    - [List Breakfast Response](#list-breakfasts-response)
...
### List Breakfasts Request

```js
GET /breakfasts/
```

### List Breakfasts Response
